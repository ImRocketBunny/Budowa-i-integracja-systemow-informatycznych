...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		return Integer.valueOf((int) (this.amount*currency.getRate()));
	}
	...
	public Boolean equals(Money other) {
		/*if(this.currency.getName().equals(other.currency.getName())){
			return null;
		}*/
		return  Integer.valueOf(this.universalValue()).equals(Integer.valueOf(other.universalValue()));
	}
	...
	public Money add(Money other) {
		int value = other.currency.valueInThisCurrency(other.amount,this.currency);
	...
	public int compareTo(Object other) {
		...
		int tvalue = this.universalValue();
		int ovalue = otherMoney.universalValue();
